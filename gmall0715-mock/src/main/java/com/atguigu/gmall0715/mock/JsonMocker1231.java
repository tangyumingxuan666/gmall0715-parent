...
public class JsonMocker1231 {
    ...
    public JsonMocker1231( )  {

    }

    public JsonMocker1231(String startTimeString , String endTimeString, int startupNum, int eventNum) {
        try {
    ...
    public static void genLog() {
        JsonMocker1231 jsonMocker = new JsonMocker1231();
